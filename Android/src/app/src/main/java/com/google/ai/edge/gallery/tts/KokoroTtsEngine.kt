    ...
    playbackJob = scope?.launch {
      ...
      try {
        ...
        for ((i, sentence) in sentences.withIndex()) {
          ...
          // Use generateWithCallback() to stream audio chunks to AudioTrack
          // in real-time as they are generated, for lower latency playback.
